...
def main():
    ...
    parser.add_argument("--tasks-file", type=str, default=os.path.join(PROJECT_ROOT, "backend", "benchmark", "tasks.json"), help="Path to tasks.json")
    parser.add_argument("--workspace", type=str, default=os.path.join(PROJECT_ROOT, "workspace"), help="Path to workspace directory")
    parser.add_argument("--memory", type=str, default=os.path.join(PROJECT_ROOT, "memory"), help="Path to memory directory")
    ...
    parser.add_argument("--report", type=str, default=os.path.join(PROJECT_ROOT, "backend", "benchmark", "results", "report.md"), help="Path to output report.md")
