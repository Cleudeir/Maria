...
from maria.ollama import getGenerate, get_last_usage, format_messages_to_prompt, strip_thinking_process
...
class OllamaClient:
    ...
    def chat(
        ...
        return getGenerate(system_text, user_text)
    ...
    def generate(
        ...
        return getGenerate(system, prompt)
